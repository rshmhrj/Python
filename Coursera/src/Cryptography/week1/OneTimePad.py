...
key = """f9n‰ÉÛØÌ˜t5*Íc•.¯Îxªí( kÉ)Åi°3šøª@;œmp€ÀfÇcþð1HÍØèÐ[©‡w3]®üìÕœC:k&‹`¿Nð<ša˜»>š1aíÇ¸"""
...
ct11 = "32510ba9babebbbefd001547a810e67149caee11d945cd7fc81a05e9f85aac650e9052ba6a8cd8257bf14d13e6f0a803b54fde9e77472dbff89d71b57bddef121336cb85ccb8f3315f4b52e301d16e9f52f904"

ht01 = Cryptography.Crypto.hex2str(ct01)
ht02 = Cryptography.Crypto.hex2str(ct02)
ht03 = Cryptography.Crypto.hex2str(ct03)
ht04 = Cryptography.Crypto.hex2str(ct04)
ht05 = Cryptography.Crypto.hex2str(ct05)
ht06 = Cryptography.Crypto.hex2str(ct06)
ht07 = Cryptography.Crypto.hex2str(ct07)
ht08 = Cryptography.Crypto.hex2str(ct08)
ht09 = Cryptography.Crypto.hex2str(ct09)
ht10 = Cryptography.Crypto.hex2str(ct10)
ht11 = Cryptography.Crypto.hex2str(ct11)

pt01 = Cryptography.Crypto.strxor(ht01,key)
pt02 = Cryptography.Crypto.strxor(ht02,key)
pt03 = Cryptography.Crypto.strxor(ht03,key)
pt04 = Cryptography.Crypto.strxor(ht04,key)
pt05 = Cryptography.Crypto.strxor(ht05,key)
pt06 = Cryptography.Crypto.strxor(ht06,key)
pt07 = Cryptography.Crypto.strxor(ht07,key)
pt08 = Cryptography.Crypto.strxor(ht08,key)
pt09 = Cryptography.Crypto.strxor(ht09,key)
pt10 = Cryptography.Crypto.strxor(ht10,key)
pt11 = Cryptography.Crypto.strxor(ht11,key)
...
test01 = "We can factor the number 15 with quantum computers in " 

test02 = "Euler would probably enjoy that now his Nheorem becomes a corner stone in cryptography "

test03 = "The nice thing about Keeyloq is now we cHyptographk;Je"

test04 = "The ciphertext produced by a weak encrypNion algorithm looks as good as "

test05 = "You don't want to buy a set of car keys \rom a guy who specializes in "

test06 = "There are two types of cryptography - th[t which will keep secrets"

test07 = "There are two types of cyptography: one Nhat allows the Government"

test08 = "We can see the point where the chip is uThappy if a wrong bit is s"

test09 = " A (private-key)  encryption scheme stateI 3 algorithms, namely a p"

test10 = " The Concise OxfordDictionary (2006) deï–nes crypto as the art of  writing o r solving codes."

test11 = "The secret message is: When using a stre[m cipher, never use the key more than once"
print Cryptography.Crypto.strxor(ht10,test10)